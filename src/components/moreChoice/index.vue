  ...
  <div class="el-transfer">
    <div class="choi c_left" :id="wrapperId">
      ...
      <ul class="choiLsit js-choiceList">
        <li v-for="choice in showChoices"  @click="addpro(choice.productId,choice.productName)" :class="{'active':ids.indexOf(String(choice.productId))!=-1}"
          :key="choice.id">
          <p :title="choice.productName">
            {{choice.productName}}</p>
