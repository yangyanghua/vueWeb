<template>
  <div class="popup">
    <el-dialog title="公共弹出组件" :visible.sync="isPopupVisible">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="isPopupVisible = false">取 消</el-button>
  ...
  export default {
    data() {
      return {
        ...
        popupTypeArr: ['goods','goodsGroup','subject','brand','shop','url'],
    ...
    methods: {
      ...
      toTitle(){
        ...
        console.log(this.currentId,this.popupTypeStr)
        this.$router.push({
          name:'title',
          params:{
            id : this.currentId || 1,
