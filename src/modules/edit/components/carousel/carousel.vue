  ...
  <div class="carousel">
    ...
    <div class="editer">
      ...
      <div class="editer-main">
        ...
        <div class="save">
          <el-button :plain="true" @click="preview()">预览</el-button>
  ...
  export default {
    ...
    watch: {
      ...
      "carouselConfig.image_show_style"(){
        ...
        this.preImgStr = require(`../../../../assets/images/edit/${this.preImgArr[this.$store.state.edit.carousel.carouselStyle-1]}`)
      }
    },
    methods: {
      changeStyle(e){
      ...
      addContentBox(){
        ...
        this.$store.commit('carouselAdd',{carouselAdd: this.carouselConfig.sub_entry})
        console.log(this.$store.state.edit.carousel.carouselAdd)
      },
      getIndex(index){
    ...
    mounted() {
      this.currentView = location.hash.slice(7);//给tabs组件判断active
      ...
      if(this.carouselConfig.sub_entry.length>0){
        this.toPopupIndex = this.$store.state.edit.carousel.toPopupIndex || 0;
