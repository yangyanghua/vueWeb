    ...
    <div class="edit-box">
      <div class="edit-preview">
        <div class="big-img" v-if="dataset && dataset.length">
          ...
          <img v-else-if="groupConfig.link_object.img" :src="groupConfig.link_object.img">
        </div>
        ...
        <div class="small-img-box" v-else-if="groupConfig.link_object.goods && groupConfig.link_object.goods.length">
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.idx = this.$store.state.edit.idxGroup;
      this.initGroup();
